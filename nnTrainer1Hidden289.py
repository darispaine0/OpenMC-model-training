#!/usr/bin/env python3
"""
Fission Matrix Coefficient Predictor
Predicts ln(coefficient) for each FM position relative to 294K reference
"""
...
class Config:
    ...
    HIDDEN_SIZE = N_CELLS       # 289 hidden neurons
    ...
    MODEL_SAVE_PATH = "fm_coefficient_model_best.pth"
...
class FMCoefficientPredictor(nn.Module):
    """Single hidden layer network: 578 -> 289 -> 83521"""
...
def main():
    ...
    plot_training_history(logger, cfg.RESULTS_DIR / "training_curve.png")
